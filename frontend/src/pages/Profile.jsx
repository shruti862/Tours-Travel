...
function Profile() {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios({
          method: "GET",
          url: "https://tours-travel-liard.vercel.app/api/v1/users/me",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios({
        method: "PATCH",
        url: "https://tours-travel-liard.vercel.app/api/v1/users/updateMe",
        withCredentials: true,
        data: formData,
      });
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      const response = await axios({
        method: "PATCH",
        url: "https://tours-travel-liard.vercel.app/api/v1/users/updateMyPassword",
        withCredentials: true,
        data: {
                ...
                <div className={styles["form__group"]}>
                  <div className={styles["form__photo-upload"]}>
                    <img
                      ...
                      src={
                        `https://tours-travel-liard.vercel.app/img/users/` +
                        user.photo
                      }
                      alt="User photo"
                    />
