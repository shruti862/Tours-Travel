    ...
    const fetchTourData = async () => {
      try {
        const response = await axios({
          method: "GET",
          url: `https://tours-travel-tawny.vercel.app/tour/${slug}`,
        });
  ...
  const handlebookTour = async (e, tourId) => {
    ...
    try {
      const {
        ...
        method: "GET",
        url: `https://tours-travel-tawny.vercel.app/api/v1/bookings/checkout-session/${tourId}`,
      ...
      <section className={styles.section_header}>
        <div className={styles.header_hero}>
          ...
          <img
            ...
            src={`https://tours-travel-tawny.vercel.app/img/tours/${tourData.imageCover}`}
            alt={`${tourData.name}`}
          />
        </div>
            ...
            <div className={styles.overviewBoxGroup}>
              ...
              {tourData.guides?.map((guide, idx) => (
                <div className={styles.overviewBoxDetail} key={idx}>
                  <img
                    src={`https://tours-travel-tawny.vercel.app/img/users/${guide.photo}`}
                    alt={`${guide.name}`}
      ...
      <section className={styles.sectionPictures}>
        {tourData.images?.map((image, idx) => (
          <div className={styles.pictureBox} key={idx}>
            <img
              src={`https://tours-travel-tawny.vercel.app/img/tours/${image}`}
